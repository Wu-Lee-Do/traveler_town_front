...
-   여행자들을 위한 커뮤니티 "Traveler Town" 프로젝트

### 🚀 목적

-   사용자들 간의 정보 제공 및 공유, 국가 정보 제공
...
-   동행, 여행지, 맛집 게시판 페이지
    ...
    > 글쓴이 추가정보(나이, 성별) 출력 - 동행 게시판만 해당

-   게시판 작성 페이지

    > 제목, 해당 국가, 내용 입력 가능

    > 국가 선택시 왼쪽에 해당 국가 정보 출력

    > 내용에 이미지 첨부 가능

    > 게시물 작성시 회원 정보 나이, 성별 추가 설정 필요 - 동행 게시판만 해당
